...
- radix-nova 스타일 variant로 Shadcn UI 컴포넌트 통합
...
- Shadcn UI의 radix-nova 스타일 테마 적용
  ...
  <table className="w-full text-sm">
    ...
    <tbody>
      ...
      <tr className="border-t">
        <td className="px-4 py-3">예시 항목</td>
